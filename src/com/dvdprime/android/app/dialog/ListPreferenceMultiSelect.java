...
public class ListPreferenceMultiSelect extends ListPreference {
	private int type = -1; // -1:not delete, >0:delete
...
//        checkAllKey = a.getString( R.styleable.ListPreferenceMultiSelect_checkAll );
        ...
        if( s != null ) {
        	...
        	separator = Const.DEFAULT_SEPARATOR;
        }
    ...
    public ListPreferenceMultiSelect(Context context, int type) {
    	this(context, null);
    	this.type = type;
    }
...
//        			}
            ...
            if (callChangeListener(values)) {
        		...
        		if (type > 0)
        			PrefUtil.getInstance().setString(PreferenceKeys.FILTERING_NICK_LIST, join(values2, separator));
            }
        }
    }
